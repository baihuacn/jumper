...
;(function() {
  ...
  function Block() {
    ...
    function createBlock() {
      ...
      var newBlockHeight = Math.ceil(
        _this.blockInfo.maxHeight -
          ((_this.blockInfo.maxHeight - _this.blockInfo.minHeight) * Math.random() * totalBlockNum) / toMaxRandomScore
      )
      ...
      var width = Math.ceil(
        _this.blockInfo.minWidth + (_this.blockInfo.maxWidth - _this.blockInfo.minWidth) * Math.random()
      )
      var distance = Math.ceil(
        minDistance + ((maxDistance - minDistance) * randomNoZero() * totalBlockNum) / toMaxRandomScore
      )
